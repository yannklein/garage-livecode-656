...
var map = {
	"./garage_controller.js": "./src/controllers/garage_controller.js"
};
...
/***/ "./src/controllers/garage_controller.js":
/*!**********************************************!*\
  !*** ./src/controllers/garage_controller.js ***!
  \**********************************************/
...
var myBadAssGarage = "yanns-yarn-barn";
  ...
  _createClass(_default, [{
    ...
    value: function showCars() {
      ...
      fetch(this.url).then(function (response) {
        ...
        _this2.displayCarList(data);
      });
    }
  }, {
    key: "displayCarList",
    value: function displayCarList(cars) {
      var _this3 = this;

      this.carListTarget.innerHTML = "";
      cars.forEach(function (car) {
        _this3.carListTarget.insertAdjacentHTML("beforeend", "<div class=\"car\">\n          <div class=\"car-image\">\n            <img src=\"http://loremflickr.com/280/280/".concat(car.brand, " ").concat(car.model, "\" />\n          </div>\n          <div class=\"car-info\">\n            <h4>").concat(car.brand, " ").concat(car.model, "</h4>\n            <p><strong>Owner:</strong>").concat(car.owner, "</p>\n            <p><strong>Plate:</strong>").concat(car.plate, "</p>\n          </div>\n        </div>\n        "));
      });
    }
  }]);

  return _default;
}(stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]); // 1 Define targets in the HTML  form + button and car list
...
_defineProperty(_default, "targets", ['brand', 'model', 'plate', 'owner', 'carList']);
